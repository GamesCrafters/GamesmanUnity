...
public class CubicTTT : AbstractGame<TTTGameState, TTTGameMove>
{
    ...
    public CubicTTT(int size)
    {
        Size = size;
        State = new TTTGameState(size, Piece.x);
    }
    ...
    public override IList<TTTGameMove> GenerateMoves()
    {
        return GenerateMoves(State);
    }

    public override IList<TTTGameMove> GenerateMoves(TTTGameState state)
    {
