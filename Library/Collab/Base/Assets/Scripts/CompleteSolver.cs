...
public class CompleteSolver: AbstractSolver
{
    ...
    public override GameValue GetStatusValue(GameState gameState)
    {
        return Memory[Game.SerializeState(gameState)];
    }

    public override GameMove GetMove(GameState gameState)
    {
    ...
    private GameValue Solve(GameState state)
    {
        bool winFlag = false;
